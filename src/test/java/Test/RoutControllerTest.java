...
public class RoutControllerTest {
    ...
    public void testGetHeartRouteSuccess() throws Exception {
        ...
        Mockito.when(routeService.generateCustomShapeRoute(5.0, 50.0, 20.0)).thenReturn(mockRoute);
    ...
    public void testGetHeartRouteEmptyRoute() throws Exception {
        ...
        Mockito.when(routeService.generateCustomShapeRoute(5.0, 50.0, 20.0)).thenReturn(Collections.emptyList());
        mockMvc.perform(get("/routes/heart")
                        .param("distance", "5.0"))
